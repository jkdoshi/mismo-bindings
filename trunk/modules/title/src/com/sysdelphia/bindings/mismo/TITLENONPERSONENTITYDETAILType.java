...
public class TITLENONPERSONENTITYDETAILType {
  ...
  public void addAUTHORIZEDREPRESENTATIVE(TITLEAUTHORIZEDREPRESENTATIVEType authorizeDREPRESENTATIVE) {
    authorizeDREPRESENTATIVEList.add(authorizeDREPRESENTATIVE);
  }

  public TITLEAUTHORIZEDREPRESENTATIVEType getAUTHORIZEDREPRESENTATIVE(int index) {
    return (TITLEAUTHORIZEDREPRESENTATIVEType)authorizeDREPRESENTATIVEList.get( index );
  }
