...
public class TITLEEMBEDDEDFILEType {
  ...
  public void addDOCUMENT(TITLEDOCUMENTType document) {
    documentList.add(document);
  }

  public TITLEDOCUMENTType getDOCUMENT(int index) {
    return (TITLEDOCUMENTType)documentList.get( index );
  }
