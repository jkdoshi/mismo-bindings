...
public class TITLEPROPERTYType {
  protected TITLEPROPERTYIDENTIFICATIONType _IDENTIFICATION;

  protected TITLEPROPERTYLEGALDESCRIPTIONType _LEGALDESCRIPTION;

  protected TITLEPARSEDSTREETADDRESSType parseDSTREETADDRESS;
  ...
  public TITLEPROPERTYIDENTIFICATIONType get_IDENTIFICATION() {
    return this._IDENTIFICATION;
  }

  public void set_IDENTIFICATION(TITLEPROPERTYIDENTIFICATIONType _IDENTIFICATION) {
    this._IDENTIFICATION = _IDENTIFICATION;
  }

  public TITLEPROPERTYLEGALDESCRIPTIONType get_LEGALDESCRIPTION() {
    return this._LEGALDESCRIPTION;
  }

  public void set_LEGALDESCRIPTION(TITLEPROPERTYLEGALDESCRIPTIONType _LEGALDESCRIPTION) {
    this._LEGALDESCRIPTION = _LEGALDESCRIPTION;
  }

  public TITLEPARSEDSTREETADDRESSType getPARSEDSTREETADDRESS() {
    return this.parseDSTREETADDRESS;
  }

  public void setPARSEDSTREETADDRESS(TITLEPARSEDSTREETADDRESSType parseDSTREETADDRESS) {
